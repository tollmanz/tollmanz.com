...
![Chrome net-internals query for tollmanz.com, showing its stored HSTS and HPKP data including upgrade mode, include-subdomains flags, and SPKI hashes](/media/images/domain-query-hpkp.png)
