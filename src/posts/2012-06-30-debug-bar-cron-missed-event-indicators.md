...
![Debug Bar Cron panel showing a missed scheduled event, with the next event time highlighted in red and a custom events table listing each hook and interval](/media/images/missed-event.png)
