...
| `talkFilterStates`  | `filters/talks.js`   | Every filter state, with its CSS fragments and talk count |
| `emptyFilterStates` | `filters/talks.js`   | The loosest filter states that match no talk              |
